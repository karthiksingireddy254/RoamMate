  ...
  return (
    <header className="sticky top-0 z-40 bg-slate-950 border-b border-slate-800 px-3 sm:px-4 py-2.5 shadow-xl">
      <div className="max-w-7xl mx-auto flex flex-col gap-2.5">
        ...
        {/* Row 1: Brand Logo, Location Badges, Navigation Tabs & User Profile */}
        <div className="flex items-center justify-between gap-3 flex-wrap">
          
          {/* Logo & Location Badges */}
          ...
          {/* Right Row: Navigation Tabs, View Switcher & User Profile */}
          ...
          <form onSubmit={handleSearchSubmit} className="relative flex-1 flex items-center gap-2 w-full">
            <div className="relative flex-1 w-full">
              ...
              <input
                ...
                placeholder="🔎 Search services & attractions (e.g. Mechanic, Taj Mahal, Hotel, Petrol, Medchal)"
